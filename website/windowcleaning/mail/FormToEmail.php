...
.navbar-brand {
	...
	<body id="page-top" class="big-salon" data-spy="scroll" data-target=".navbar-custom">
		<div class="fixedcallicon">
			<i class="fa fa-phone"></i><span><a href="tel:35314053993">CLICK To Book An Appointment</a></span>
		</div>
		<nav class="navbar navbar-inverse">
			<div class="container-fluid">
				<div class="navbar-header">
										
					<a class="navbar-brand" href="#"><img src="img/logo.png" class="img-circle" width="200" height="60"></a>
		...
		<section id="intro" class="intro" >
			...
			<div class="container">
				<div class="row">
					...
					<br>
						<a class="myHouse" href="www.eastsidewindowcleaning.ie"><i class="fa fa-home" style="font-size:60px;color:#bc9355;" aria-hidden="true"></i></a>
