		...
		<section id="intro" class="intro" >
			...
			<div class="container">
				<div class="row">
					...
					<br>
					<p>Please Click the home icon below to return to homepage..</p>
					<br>
						<a class="myHouse" href="http://www.oliviashairsalon.ie/"><i class="fa fa-home" style="font-size:60px;color:#bc9355;" aria-hidden="true"></i></a>
