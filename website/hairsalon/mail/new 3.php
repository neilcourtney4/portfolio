...
$my_email = "neil.courtney4@gmail.com";
		...
		<section id="intro" class="intro" >
			...
			<div class="container">
				<div class="row">
					...
					<br>
					<a class="myHouse" href="www.oliviashairsalon.ie/index.html"><i class="fa fa-home" style="font-size:60px;color:#bc9355;" aria-hidden="true"></i></a>
